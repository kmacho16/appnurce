...
<div class="row">
	<div id="controles" style="margin-top:2em;padding: 0 30px">
        ...
        <div class="col-md-2 pull-right" style="background-color: #fff; height: 600px;border-radius: 0 20px 20px 0;">
        	...
        	<a target="_blank" href="{{ url('profile') }}" class="btn btn-block btn-primary pull-bottom"><i class="fa fa-user" aria-hidden="true"></i> VER PERFIL</a target="_blank">
        	<hr>
			...
			{!! Form::model(Request::only(['lat','lng','rad']),['url'=>'/search','method'=>'get']) !!}{{-- 
				...
				{!! Form::hidden('lat',null,["id"=>"lat","value"=>"4.683940718364223"]) !!}
				{!! Form::hidden('lng',null,["id"=>"lng","value"=>"-74.09151578657224"]) !!}
